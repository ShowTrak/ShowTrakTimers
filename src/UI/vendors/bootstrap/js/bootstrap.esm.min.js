...
class BaseComponent {
  constructor(e) {
    (e = getElement(e)) &&
      ((this._element = e), Data.set(this._element, this.constructor.DATA_KEY, this));
  }
  dispose() {
...
const Manipulator = {
  ...
  SWIPE_THRESHOLD = 40,
  Default$9 = { interval: 5e3, keyboard: !0, slide: !1, pause: 'hover', wrap: !0, touch: !0 },
  DefaultType$9 = {
...
class Carousel extends BaseComponent {
  ...
  _getItemIndex(e) {
    return (
      (this._items = e && e.parentNode ? SelectorEngine.find(SELECTOR_ITEM, e.parentNode) : []),
...
class Collapse extends BaseComponent {
  ...
  static collapseInterface(e, t) {
    ...
    if (
      (!n && i.toggle && 'string' == typeof t && /show|hide/.test(t) && (i.toggle = !1),
...
class Dropdown extends BaseComponent {
  ...
  _selectMenuItem({ key: e, target: t }) {
    const n = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, this._menu).filter(isVisible);
    n.length && getNextActiveElement(n, t, 'ArrowDown' === e, !n.includes(t)).focus();
  }
  ...
  static dataApiKeydownHandler(e) {
    if (
      /input|textarea/i.test(e.target.tagName)
        ? 'Space' === e.key ||
          ('Escape' !== e.key &&
            (('ArrowDown' !== e.key && 'ArrowUp' !== e.key) || e.target.closest(SELECTOR_MENU)))
...
const Default$6 = { isVisible: !0, isAnimated: !1, rootElement: 'body', clickCallback: null },
  DefaultType$6 = {
    isVisible: 'boolean',
    isAnimated: 'boolean',
...
class Backdrop {
  ...
  _getConfig(e) {
    return (
      ((e = { ...Default$6, ...('object' == typeof e ? e : {}) }).rootElement = getElement(
        e.rootElement
      )),
...
class Modal extends BaseComponent {
  ...
  show(e) {
    this._isShown ||
      ...
      EventHandler.on(this._element, EVENT_CLICK_DISMISS$2, SELECTOR_DATA_DISMISS$2, (e) =>
        this.hide(e)
      ),
...
class Offcanvas extends BaseComponent {
  ...
  show(e) {
    this._isShown ||
      ...
      this._backdrop.show(),
      this._config.scroll ||
        (new ScrollBarHelper().hide(), this._enforceFocusOnElement(this._element)),
      this._element.removeAttribute('aria-hidden'),
      this._element.setAttribute('aria-modal', !0),
      this._element.setAttribute('role', 'dialog'),
      this._element.classList.add('show'),
      this._queueCallback(
        () => {
          EventHandler.trigger(this._element, EVENT_SHOWN$2, { relatedTarget: e });
        },
        this._element,
        !0
      ));
  ...
  dispose() {
    (this._backdrop.dispose(), super.dispose(), EventHandler.off(document, EVENT_FOCUSIN$1));
  }
  _getConfig(e) {
    return (
      (e = {
...
const uriAttrs = new Set([
  ...
  allowedAttribute = (e, t) => {
    ...
    if (t.includes(n))
      return (
        !uriAttrs.has(n) ||
        Boolean(SAFE_URL_PATTERN.test(e.nodeValue) || DATA_URL_PATTERN.test(e.nodeValue))
      );
...
class Tooltip extends BaseComponent {
  ...
  show() {
    ...
    (Data.set(i, this.constructor.DATA_KEY, this),
      this._element.ownerDocument.documentElement.contains(this.tip) ||
        (a.appendChild(i), EventHandler.trigger(this._element, this.constructor.Event.INSERTED)),
      this._popper
        ? this._popper.update()
        : (this._popper = Popper.createPopper(this._element, i, this._getPopperConfig(r))),
  ...
  setContent() {
    const e = this.getTipElement();
    (this.setElementContent(SelectorEngine.findOne('.tooltip-inner', e), this.getTitle()),
      ...
      return isElement(t)
        ...
        : void (this._config.html
            ? (this._config.sanitize &&
                (t = sanitizeHtml(t, this._config.allowList, this._config.sanitizeFn)),
              (e.innerHTML = t))
            : (e.textContent = t));
  }
  getTitle() {
  ...
  _initializeOnDelegatedTarget(e, t) {
    ...
    return (
      (t = t || Data.get(e.delegateTarget, n)) ||
        ((t = new this.constructor(e.delegateTarget, this._getDelegateConfig())),
  ...
  _setListeners() {
    (this._config.trigger.split(' ').forEach((e) => {
      if ('click' === e)
        EventHandler.on(this._element, this.constructor.Event.CLICK, this._config.selector, (e) =>
          this.toggle(e)
        );
      else if ('manual' !== e) {
        const t =
        ...
        (EventHandler.on(this._element, t, this._config.selector, (e) => this._enter(e)),
          EventHandler.on(this._element, n, this._config.selector, (e) => this._leave(e)));
      }
    }),
  ...
  _getConfig(e) {
    ...
    return (
      ...
      ((e = {
        ...
        ...t,
        ...('object' == typeof e && e ? e : {}),
      }).container = !1 === e.container ? document.body : getElement(e.container)),
  ...
  getTipElement() {
    return (
      this.tip ||
        ...
        this.getTitle() || SelectorEngine.findOne(SELECTOR_TITLE, this.tip).remove(),
        this._getContent() || SelectorEngine.findOne('.popover-body', this.tip).remove()),
      this.tip
    );
  }
  setContent() {
...
class ScrollSpy extends BaseComponent {
  ...
  _activate(e) {
    ...
    (n.classList.contains('dropdown-item')
      ? (SelectorEngine.findOne('.dropdown-toggle', n.closest('.dropdown')).classList.add('active'),
...
class Tab extends BaseComponent {
  ...
  show() {
    ...
    if (
      EventHandler.trigger(this._element, EVENT_SHOW$1, { relatedTarget: e }).defaultPrevented ||
  ...
  _transitionComplete(e, t, n) {
    ...
    let i = e.parentNode;
    if (
      (i && 'LI' === i.nodeName && (i = i.parentNode), i && i.classList.contains('dropdown-menu'))
    ) {
      const t = e.closest('.dropdown');
      (t && SelectorEngine.find('.dropdown-toggle', t).forEach((e) => e.classList.add('active')),
